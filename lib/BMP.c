 ...
 */
int
BMP_draw_string (BMP *bmp, char *string, int x, int y, RGB color)
{
	char ch, *s;
	RGB r,g,b;
	RGB light, dark;
...
BMP_draw_mini_string (BMP *bmp, char *string, int x, int y, RGB color)
{
	...
	char **mini_chars = get_minifont_chars ();
 ...
 */
int
BMP_draw_narrow_numbers (BMP *bmp, char *string, int x, int y, RGB color)
{
	char ch, *s;
